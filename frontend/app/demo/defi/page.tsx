...
export default function DefiDemoPage() {
  ...
  return (
    <DemoWrapper
      title="DeFi"
      description="Demo swapping tokens in a DeFi protocol."
      action="swap"
    >
      <div className="space-y-5">
        ...
        <Card className="border-border/50 bg-background/40 w-full max-w-md shadow-2xl backdrop-blur-xl">
          ...
          <CardContent className="space-y-3">
            <Input placeholder="Enter your wallet address to claim test tokens for swapping" />
